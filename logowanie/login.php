...
<head>
	...
	<style>
		body{
			...
			background: linear-gradient(to bottom, #0f0c29, #17181F, #17181F);
		}
		.main {
			width: 350px;
			height: 500px;
		...
		<input type="checkbox" id="chk" aria-hidden="true">
			...
			<div class="signup">
				<form method="post">
					...
					<?php
						echo("<center><p id=\"warning\">$warning</p></center>");
					?>

					<input id="text" type="text" name="user_name" placeholder="email">
			...
			<div class="login">
					...
					<input id="text" type="password" name="password" placeholder="hasło" >
					<p><a href="signup.php">test odnosnika w rej</a></p>
